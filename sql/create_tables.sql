...
CREATE TABLE products (
	...
	row_created_timestamp DATETIME DEFAULT CURRENT_TIMESTAMP,
	qu_id_consume INTEGER, auto_reprint_stock_label TINYINT NOT NULL DEFAULT 0, quick_open_amount REAL NOT NULL DEFAULT 1, qu_id_price INTEGER, disable_open TINYINT NOT NULL DEFAULT 0, default_purchase_price_type TINYINT NOT NULL DEFAULT 1, parent_or_self_id INTEGER);
