# CREATE_TABLES Transformation Report
...
**Flags:** CHECK constraints (review semantics)

**Automatic CHECK conversions applied:** CHECK converted:
...
```sql
CREATE TABLE sqlite_sequence(name,seq) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
```
...
**Automatic CHECK conversions applied:** CHECK converted:, CHECK converted to ENUM:
...
## cache__products_last_purchased
